...
class GoogleSigninServiceImpl implements GoogleSigninService {
  ...
  Future<Result<String>> signIn() async {
    try {
      ...
      return Failure(
        Exception('Failed to retrive Id from google sign in'),
      );
    } catch (e, s) {
      log(
        'Failed to retrive Id from google sign in',
        name: 'GoogleSignInService',
        error: e,
        stackTrace: s,
      );
      return Failure(Exception('Failed to retrive Id from google sign in'));
    }
  }
